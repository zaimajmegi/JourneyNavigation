    ...
    public partial class initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    AchievesDailyGoal = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArrivalLocation = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false),
                    DistanceInMeters = table.Column<int>(type: "int", nullable: false),
                    JourneyUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Journeys_AspNetUsers_JourneyUserId",
                        column: x => x.JourneyUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Journeys_TransportationTypes_TransportationTypeId",
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "Id", "Transportation" },
                values: new object[] { 1, "Car" });

            migrationBuilder.InsertData(
                table: "TransportationTypes",
                columns: new[] { "Id", "Transportation" },
                values: new object[] { 2, "Airplane" });

            migrationBuilder.InsertData(
                table: "TransportationTypes",
                columns: new[] { "Id", "Transportation" },
                values: new object[] { 3, "Bus" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Journeys_JourneyUserId",
                table: "Journeys",
                column: "JourneyUserId");
